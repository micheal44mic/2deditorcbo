window.CBO = window.CBO || {};
  ...
  `,
    ...
    `,
    freeResize: `
      <svg class="lucide lucide-expand-icon lucide-expand" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
window.CBO.createMobileTransformTools = function createMobileTransformTools() {
  return `
    <div class="tool-group mobile-transform-tool-group" aria-label="Transform tools" data-mobile-transform-tools>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="RESIZE" aria-pressed="false" data-tooltip="RESIZE" data-transform-aspect-lock="true" data-transform-select-mode="free" data-tool-mode="resize" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.resize}
      </button>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="FREE RESIZE" aria-pressed="false" data-tooltip="FREE RESIZE" data-transform-aspect-lock="false" data-transform-select-mode="free" data-tool-mode="resize" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.freeResize}
      </button>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="ROTATE" aria-pressed="false" data-tooltip="ROTATE" data-transform-aspect-lock="false" data-transform-select-mode="free" data-tool-mode="rotate" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.rotate}
      </button>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="DISTORTION" aria-pressed="false" data-tooltip="DISTORTION" data-transform-aspect-lock="false" data-transform-select-mode="warp" data-tool-mode="resize" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.distort}
      </button>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="PERSPECTIVE" aria-pressed="false" data-tooltip="PERSPECTIVE DISTORTION" data-transform-aspect-lock="false" data-transform-select-mode="perspective" data-tool-mode="resize" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.perspective}
      </button>
      <button class="tool-button mobile-transform-tool-button" type="button" aria-label="PUPPET" aria-pressed="false" data-tooltip="PUPPET" data-transform-aspect-lock="false" data-tool-mode="puppet" data-tool>
        ${CBO_TRANSFORM_TOOL_ICONS.puppet}
      </button>
    </div>
  `;
