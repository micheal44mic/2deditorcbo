...
test("artboard connections live in their own module", () => {
  ...
  assert.match(connectionsSource, /AI_IMAGE_GENERATION_PREVIEW_MS = 0/);
  ...
  assert.match(connectionsSource, /element\.classList\.toggle\("is-generating", isGenerating && isHeavyMounted && !plainArtboardMode\)/);
  ...
  assert.match(indexSource, /ai-board-offscreen-idle-v10/);
