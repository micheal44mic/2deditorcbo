...
test("AI image boards can open a responsive enlarge viewer", () => {
  ...
  assert.match(connectionsSource, /kind !== "image"/);
...
test("AI image boards expose a responsive create with AI preview shell", () => {
  ...
  assert.match(connectionsSource, /function syncAiImageEditPreviewPromptToBoard\(input\)/);
  assert.match(connectionsSource, /setAiImageBoardPromptText\(board, value/);
  ...
  assert.match(cssSource, /\.editor-ai-image-edit-preview-prompt-input[\s\S]*resize: none/);
