...
test("left rail exposes a visual artboard tool below layers", () => {
  ...
  assert.match(indexSource, /<script src="\.\/js\/document\/document-artboard-model\.js\?v=android-v3\.4-fillworker-sparse"><\/script>/);
  assert.match(indexSource, /<script src="\.\/js\/artboard-preview\.js\?v=android-v3\.4-fillworker-sparse"><\/script>/);
});
